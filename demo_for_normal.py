...
# normal weights:
def get_normal_weights(model):

    weight_list = []
    for key, val in model.items():
        val_numpy = val.numpy()
        weight_list.append(val_numpy)
...
weight_list_x = get_normal_weights(model_x)
weight_list_y = get_normal_weights(model_y)
...
if not os.path.exists("results"):
    os.makedirs("results")
save_path = "results/ALL_normal_" + model_x_name + "_with_" + model_y_name
